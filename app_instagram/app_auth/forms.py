...
class RegisterForm(UserCreationForm):
    username = CharField(max_length=26, min_length=3, required=True, widget=TextInput(attrs={"class": "form-control"}))
    email = EmailField(max_length=26, required=True, widget=EmailInput(attrs={"class": "form-control"}))
